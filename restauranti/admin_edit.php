...
<?php
							...
							if ( isset($_POST['rez_id']) && isset($_POST['rez_dataRezervimit']) && isset($_POST['rez_dataEventit']) && isset($_POST['rez_fillimiEventit'])&& isset($_POST['rez_kohezgjatja'])
							...
							$sql = "UPDATE rezervimi  SET rez_dataRezervimit='$t', rez_dataEventit='$m' , rez_fillimiEventit='$g' ,rez_kohezgjatja='$d', nr_ulesve='$q', menu_id='$r', klienti_id='$s' where rez_id=$n"or die(mysql_error());
					...
					<section id="content"><div class="ic"></div>
						...
						<div class="btns"><input type="submit" value="Ndrysho" class="link" /></div>
