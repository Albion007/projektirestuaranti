...
<?php
							...
							$sql = "UPDATE menu  SET menu_lloji='$l' where menu_id=$i"or die(mysql_error());
					...
					<section id="content"><div class="ic"></div>
						...
						<div class="btns"><input type="submit" value="Ndrysho" class="link" /><a href="a_menu.php" class="link" >Anulo</a></br></div>
