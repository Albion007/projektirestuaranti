...
if (fail == "") return true
  ...
  <!--==============================header=================================-->
    <header>
        <h1><a href="index.php"><img src="images/logo.jpg" alt=""></a></h1><a href="k_logout.php" >Qkyqu</a></p></div>
        <nav>  
            <ul class="menu">
...
<?php
		...
		else if(strlen($p) < 6 && strlen($p)> 0)
		{
			echo '<p id="gjatesiapasswordit">Passwordi duhet te jete me i gjate se 6 karaktere</p><br/>';
								...
								{
								$sql = "INSERT INTO klienti VALUES (NULL, '$t', '$m', '$u', '$p', '$g', '$v','$konf')"or die(mysql_error());
						...
						<label><strong>Emri i shfrytezuesit:</strong><input name="k_username"  type="text" value=""><strong class="clear"></strong></label>
						...
						<!--<br /><div class="btns"><a href="k_rezervimet.php" class="link">Regjistrohu</a> --><input type="submit" value="Regjistrohu" /></div>
