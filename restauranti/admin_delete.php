  ...
  <!--==============================header=================================-->
    <header>
        ...
        <nav>  
            ...
            <ul class="menu">
				<li class="current"><a href="admin_delete.php">Fshirja</a></li>
            </ul>
            <div class="clear"></div>
         </nav>
    </header>  
...
if ( isset($_POST['delete']) && isset($_POST['rez_id']) ) {
$rez_id = $_POST['rez_id'];
$sql = "DELETE FROM rezervimi WHERE rez_id = $rez_id";
echo "<pre>\n$sql\n</pre>\n";
mysql_query($sql);
