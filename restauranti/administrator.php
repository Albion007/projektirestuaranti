...
<section id="content">	<div class="ic"></div>		
	...
	<h3 class="h3-line">Kyquni:</h3>
                            ...
                            <form method="post" id="form" action="a_autentifikimi.php" autocomplete="on" onSubmit="return validate(this)"> 
								 ...
								 <label><strong>Emri shfrytezuesit:</strong><input name="username" height="30" placeholder="shkruani emrin e shfrytezuesit" required="required" type="text" value=""><strong class="clear"></strong></label>
                              ...
                              <input type="submit" value="Kycu" /></br>
