	...
	<div class="bg-top">
		<div class="bgr">
			...
			<header>
				...
				<nav>
					<ul class="menu">
						<li class="current"><a href="kycja.php">Kyçja</a></li>
					</ul>
					<div class="clear"></div>
				</nav>
			</header>
			...
			<section id="content">
				...
				<div class="col-4 left-2">
					...
					<form id="form" method="post" action="">
						<fieldset>
							<label><strong>Emri shfrytzuesit:</strong><input name="k_username" type="text" value=""><strong class="clear"></strong></label>
							<label><strong>Fjalekalimi:</strong><input name="k_password" type="password" value=""><strong class="clear"></strong></label>

							<strong class="clear"></strong>
							<div class="btns">
								<input type="submit" value="Kyçu" style="height: 30px; width: 50px; position:relative; margin-left: 160px; border: 2px;">
								<br>
								<br>
								<a href="index.php" class="link" style=" position:relative; margin-right: 108px;">Anulo</a>
								<br>
								<a href="regjistrohu.php" class="link" style=" position:relative; margin-right: 95px;">Regjistrohu</a>
								<br>
								<br>
							</div>
						</fieldset>
