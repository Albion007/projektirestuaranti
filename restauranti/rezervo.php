		...
		<div class="kycja"><p style='float: right; clear: right;'><a href="kycja.php" >Kyçu</a></p></div>
            <ul class="menu">
				...
				<li><a href="galeria.php">Fotogaleria</a></li>
				 <!--<li class="current"><a href="rezervo.php">Rezervoni</a></li>-->
  ...
  <!--==============================content================================-->
    <section id="content"><div class="ic"></div>
       ...
       <div class="block-2 pad-1">
       	<div class="col-1">
        	<h2 class="h2-line">Ne jemi të nderuar t'ju ftojmë tek ne!<strong>Rezervoni online tek ne!</strong></h2>
            <div class="box-1">
            	<div class="img-border img-indent"><img src="images/page1-img1.jpg" alt=""></div>
                <div class="extra-wrap">
                	<p class="it-bold p2">Per te rezervuar ne menyre online ne restaurantin tone, <strong>ju thjesht duhet te regjistroheni duke dhene te dhenat tuaja personale, pastaj ne ju drejtojme tek informatat qe ju duhet te jepni per rezervimin, dhe kaq ju mjafton per te kryer nje pune shpejt dhe ne menyre efikase.</strong> </p>
                   <h2 class="h2-line"><strong>Me pak fjale, vazhdoni ketu <a href="kycja.php">Rezervimi online</a></strong></h2>
